...
edit_article_btn = WebDriverWait(
    browser, 5).until(
    EC.visibility_of_element_located((By.XPATH, '//*[@id="app"]/div/div[1]/div/div/span/a/span'))
).click()
#edit_article_btn = browser.find_element_by_xpath('//*[@id="app"]/div/div[1]/div/div/span/a/span').click()

new_title = "MEGVÁLTOZOTT"
title_list.append(new_title)
change_title = WebDriverWait(
    browser, 5).until(
    EC.visibility_of_element_located((By.XPATH, '//*[@id="app"]/div/div/div/div/form/fieldset/fieldset[1]/input'))
)
change_title.clear()
